...
bool Protocol::sendMsg(T msg)
{
    ...
    //uint16_t temp = calculateCheckSum(&packet);
    //std::cout << "CHECKSUM= " << temp << std::endl;
...
template bool Protocol::sendReplyMsg<msgConfig_t>(msgConfig_t msg);
template bool Protocol::sendReplyMsg<msgPeriod_t>(msgPeriod_t msg);
template bool Protocol::sendReplyMsg<msgToaDiag_t>(msgToaDiag_t msg);
template bool Protocol::sendReplyMsg<msgToa_t>(msgToa_t msg);
